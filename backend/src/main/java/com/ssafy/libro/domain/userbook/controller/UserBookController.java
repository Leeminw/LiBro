...
public class UserBookController {
    ...
    //    특정 유저가 특정 도서를 등록했는지 여부
    @GetMapping("/contain")
    public ResponseEntity<?> containUserBook(@RequestParam Long bookId) {
        return ResponseEntity.status(HttpStatus.OK).body(userBookService.getUserBookByUserAndBook(bookId));
    }
