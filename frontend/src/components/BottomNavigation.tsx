...
const BottomNavigation = () => {
  ...
  return (
    <div className="fixed z-30 w-full h-16 max-w-md -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
